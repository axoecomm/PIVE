                ...
                <div class="container" style="margin: 30px;">
                    <nav class="navbar navbar-light bg-light">
                        <form class="form-inline">
                            <button class="btn btn-outline-secondary btn-lg" style="margin: 10px" type="button" onclick="location.href = '{{ route('convertidor') }}'">Convertir a JSON desde URL</button>
                            <button class="btn btn-success btn-lg" style="margin: 10px" type="button" onclick="location.href = '{{ route('convertidorJson') }}'">Convertir a JSON desde JSON</button>
                        </form>
                    </nav>
                    
                    <hr color="blue" size=3>
                    <form id="convertidorJSON" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="col">
                                <p>Seleccione el archivo JSON que desea convertir.</p>
                            </div>
                            <div class="col">
                                <input type="file"  class="form-control" id="file" name="file" accept=".json" required>
                            </div>
                            <div class="col">
                                <button id="convertidorJSON" name='convertidorJSON' class="btn btn-primary btn-lg float-right" onclick="cambiarMensaje()">Convertir</button>
                            </div>
                        </div>
                    <p></p>
                    </form>
