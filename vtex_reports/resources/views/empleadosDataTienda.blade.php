<x-app-layout>
                ...
                <div class="container" style="margin: 30px;">
                    <nav class="navbar navbar-light bg-light">
                        <form class="form-inline">
                            ...
                            <button class="btn btn-success btn-lg"           style="margin: 10px" type="button" onclick="location.href = '{{ route('empleadosDataTienda') }}'">Consultar tiendas</button>
                        </form>
                    </nav>
                    <div class="form-row">
                        <div class="col">
                    ...
                    <form id="dataTableCarga" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col">
                                <label>Seleccione la tienda que desea consultar: </label>
                            </div>
                            <div class="col">
                                <select id="tiendas" name='make' class="form-control" onchange="ShowSelected();" required>
                                    ...
                                    <option value='14'>Speedo</option>
                                </select> 
                            </div>
                            <div class="col">
                                <button id="mostrarTabla" name='mostrarTabla' class="btn btn-primary btn-lg float-right" onclick="cambiarMensaje()">Consultar tienda</button>
                            </div>
                        </div>
                        <hr color="blue" size=3>
                    ...
                    <tbody>
                        <div class="container">
                            ...
                            <tr class="c">
                                ...
                                <td>{{ $empleado['clusterId'] }}</td>
                                <td>{{ $empleado['accountName'] }}</td>
                            </tr>
                            @endforeach
                            @endif
                        </div>
    ...
    <script type="text/javascript">
       ...
       function cambiarMensaje() {
        var texto = document.getElementById('mostrarTabla');
        if (texto.textContent == 'Consultar tienda') {
    ...
    document.getElementById('mostrarTabla').disabled = false;
    }else{
    document.getElementById('mostrarTabla').disabled = true;
    }
    }
    }
