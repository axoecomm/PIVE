                ...
                <div class="container" style="margin: 30px;">
                    <nav class="navbar navbar-light bg-light">
                        <form class="form-inline">
                            <button class="btn btn-success btn-lg" style="margin: 10px" type="button" onclick="location.href = '{{ route('empleados') }}'">Nuevo empleado</button>
                            <button class="btn btn-outline-secondary btn-lg" style="margin: 10px" type="button" onclick="location.href = '{{ route('empleadosBaja') }}'">Baja empleado</button>
                    ...
                    <form id="nuevoEmpleado" method="post">
                        @csrf
                        <div class="row">
                            <div class="col">
